...
cp ../monkeypox-build/data/metadata_region_300_random.tsv ../monkeypox-build/results/beauti/
...
awk -F"\t" 'OFS="\t" {$1=$6"_"$5"_"$3; print}' metadata_region_300_random.tsv > meta.tsv
...
cat align.fasta | awk '/>MPXV_USA_2021_MD_USA_2021-11-01/ {getline; while(!/>/) {getline}} 1' > fixed_300_random.fasta
